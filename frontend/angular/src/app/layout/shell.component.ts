...
@Component({
  ...
  template: `
    <div class="shell">
      <app-app-header [username]="auth.session()?.username ?? ''" (logout)="logout()" />
      <div class="app-body">
        <aside class="sidebar scroll-hidden">
          <nav class="nav">
            <a routerLink="/" routerLinkActive="active" [routerLinkActiveOptions]="{ exact: true }" class="nav-link">
              ...
              <span class="nav-link__label">Главная</span>
            </a>
            <a routerLink="/market" routerLinkActive="active" class="nav-link">
              ...
              <span class="nav-link__label">Рынок</span>
            </a>
            <a routerLink="/orders" routerLinkActive="active" class="nav-link">
              ...
              <span class="nav-link__label">Ордера</span>
            </a>
            <a routerLink="/wallets" routerLinkActive="active" class="nav-link">
              <span class="nav-link__icon" aria-hidden="true">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
              ...
              <span class="nav-link__label">Кошельки</span>
            </a>
          </nav>
        </aside>
        <div class="app-page">
