...
INSERT INTO market.currencies (code, name, decimals) VALUES
    ('BTC', 'Bitcoin', 8),
    ('ETH', 'Ethereum', 8),
    ('USDT', 'Tether', 6);

INSERT INTO market.trading_pairs (symbol, base_currency_id, quote_currency_id, min_order_amount, tick_size, lot_size)
SELECT 'BTC_USDT', b.id, q.id, 0.0001, 0.01, 0.00000001
FROM market.currencies b, market.currencies q
